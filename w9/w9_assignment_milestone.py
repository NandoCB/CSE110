...
while manage_cart == True:
    ...
    if enter_action == 1:
        ...
        for a, b, c, d in zip(item_list, item_price, item_quantity, amount_list):
            
            print("|{:<20}|{:>12.2f}|${:>12.2f}|${:>10.2f}|".format(a, b, c, d))
        ...
        delete_item = input('Enter the name of the item to delete: ')
        delete_item = delete_item.capitalize()
        if delete_item in item_list:
            position = item_list.index(delete_item)
